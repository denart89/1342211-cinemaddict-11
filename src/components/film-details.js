...
const createFilmDetailsContainer = () => {
  return `<section class="film-details" style="display: none;"></section>`;
};
  ...
  return `<form class="film-details__inner" action="" method="get">
    ...
    <div class="form-details__bottom-container">
      <section class="film-details__comments-wrap">
            ${createCommentsTemplate(generateComments())}
      </section>
    </div>
  </form>`;
};

export {createFilmDetailsContainer, createFullFilmDetailsTemplate};
